...
const Page = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Sticky Header */}
      <div className="flex-row sticky top-0 z-50 w-full border-b bg-white dark:bg-[#121212] border-gray-200 dark:border-gray-700 p-4 flex items-center justify-between">
