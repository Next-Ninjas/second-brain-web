...
export const Spinner = ({ size = 32, className, ...props }: SpinnerProps) => {
  return (
    <div className="text-center" role="status">
      <svg
        aria-hidden="true"
        className={cn(
          "inline animate-spin text-gray-200 dark:text-gray-600 fill-blue-600",
          className
        )}
        width={size}
        height={size}
...
export const RoundSpinner = ({ size = 24, ...props }: SpinnerProps) => {
  return (
